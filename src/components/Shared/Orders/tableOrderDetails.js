...
export default function OrderDetailsClient({ order }) {
  ...
  const handlePrintInvoice = () => {
    const invoiceData = {
      ...
      Durum:
        order.timeline?.length > 0
          ? order.timeline[order.timeline.length - 1].label
          : "",
    ...
    if (!alreadyId) {
      ...
      localStorage.setItem("lastInvoice", JSON.stringify(invoices));
    }
        ...
        <div ref={contentRef}>
          <Card>
            ...
            <CardContent>
              ...
              <p>
                <b>Toplam:</b> ₺{order.totalPrice}
              </p>
              <p>
                <b>Ödeme:</b> {order.paymentMethod}
              </p>
              <br />
              <p>
                <b>Zaman Çizelgesi</b>
